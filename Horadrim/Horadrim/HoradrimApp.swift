...
//  Horadrim
//
//  Created by RyukieSama on 2025/12/15.
//

import SwiftUI

@main
struct HoradrimApp: App {
    ...
    private func configureStore() {
        storeManager.config.lifetimeProductID = "com.ryukiesama.horadrim.lifetime"
        storeManager.config.title = "Horadrim Pro"
        storeManager.config.privacyPolicyURL = "https://horadrim.app/privacy"
        storeManager.config.termsOfServiceURL = "https://horadrim.app/terms"
