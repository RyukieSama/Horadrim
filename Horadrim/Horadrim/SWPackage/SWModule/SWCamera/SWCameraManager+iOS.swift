...
final class SWCameraManager: NSObject, @unchecked Sendable {
    ...
    private let sessionQueue = DispatchQueue(label: "com.horadrim.camera.session")
    ...
    private let videoDataQueue = DispatchQueue(label: "com.horadrim.camera.videodata", qos: .userInitiated)
    @ObservationIgnored
