//
//  HoradrimAuthView.swift
//  Horadrim
//
//  Email-only authentication view for the Horadrim showcase app.
...
struct HoradrimAuthView: View {
    ...
    private let termsURL = URL(string: "https://www.horadrim.app/terms")!
    private let privacyURL = URL(string: "https://www.horadrim.app/privacy")!
