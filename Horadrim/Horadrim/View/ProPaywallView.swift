...
struct ProPaywallView: View {
    ...
    private var footerLinks: some View {
        VStack(spacing: 12) {
            ...
            HStack(spacing: 16) {
                Link("paywall.legal.terms", destination: URL(string: "https://horadrim.app/terms")!)
                Link("paywall.legal.privacy", destination: URL(string: "https://horadrim.app/privacy")!)
            }
            .font(.caption)
            .foregroundStyle(.secondary)
        }
